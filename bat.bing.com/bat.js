function UET(o) {
        ...
        if (t) {
            ...
            try {
                if (this.uetConfig.tcf.gdprApplies = n.gdprApplies, n.gdprApplies === !0) {
                    ...
                    this.uetConfig.tcf.adStorageAllowed ? this.addCookieIds() : this.clearCookieIds()
                }
            } catch (r) {}
    ...
    this.shouldEnforce = function(n) {
        return this.uetConfig.consent.enabled === !0 && this.uetConfig.consent.enforced === !1 || this.uetConfig.tcf.enabled === !0 && this.uetConfig.tcf.hasLoaded === !0 ? !1 : this.uetConfig.cusig.hasLoaded !== !0 ? this.isTzEnforced() : this.uetConfig.cusig.blob.bi === !0 ? !0 : this.uetConfig.cusig.blob.dt === !0 && this.uetConfig.cusig.blob.ea === !0 ? !0 : (this.uetConfig.cusig.blob.ec === !0) ? this.uetConfig.cusig.blob.dt === !0 ? !0 : this.uetConfig.cusig.blob.at === !0 ? !1 : (this.uetConfig.cusig.blob.ah === !0 || n.hasCookie === !1) ? !0 : !1 : !1
    };
    this.enforceConsent = function() {
        var t = this.getCmpData(),
            n = this.uetConfig.consent.enforced;
        this.shouldEnforce(t) ? (this.uetConfig.consent.enabled = !0, this.uetConfig.consent.adStorageAllowed = !1, this.uetConfig.consent.enforced = !0, this.clearCookieIds(), n !== !0 && this.fireConsentPing("enforced")) : n === !0 && (this.uetConfig.consent.enabled = !1, this.uetConfig.adStorageAllowed = !0, this.uetConfig.consent.enforced = !1, this.addCookieIds(), this.fireConsentPing("unenforced"))
    };
